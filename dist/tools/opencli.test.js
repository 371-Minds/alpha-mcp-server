...
const mockExecFile = globalThis.__execFileMock;
...
function stubExecSuccess(stdout, stderr = "") {
    mockExecFile.mockImplementation((_bin, _argv, _opts, cb) => {
        cb(null, { stdout, stderr });
    });
}
function stubExecError(errObj) {
    mockExecFile.mockImplementation((_bin, _argv, _opts, cb) => {
...
describe("opencli_run — success", () => {
    ...
    it("passes --format json by default", async () => {
        ...
        const calledArgv = mockExecFile.mock.calls[0][1];
...
//# sourceMappingURL=opencli.test.js.map