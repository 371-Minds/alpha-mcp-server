...
// ---------------------------------------------------------------------------
const { mockPythInstance, mockMessariInstance, mockFarcasterInstance, mockMorphoInstance, mockWalletProvider, } = vi.hoisted(() => ({
...
describe("defi_farcaster_post — happy path", () => {
    ...
    it("passes channelId when channel is provided", async () => {
        ...
        expect(mockFarcasterInstance.postCast).toHaveBeenCalledWith(expect.objectContaining({ channelId: "defi" }));
    });
});
